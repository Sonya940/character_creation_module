...
def special(char_name: str, char_class: str) -> str:
    """Определяет специальное умение класса."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Предоставляет выбор и подтверждение класса."""
    approve_choice = ''
    char_class = ''
